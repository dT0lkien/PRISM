...
android {
    ...
    defaultConfig {
        ...
        ndk {
            // Ядро занимает около 60 МБ на архитектуру. Четыре в одном APK дали бы
            // четверть гигабайта, поэтому оставляем только реально нужные:
            // arm64 — все современные телефоны, x86_64 — эмулятор на Intel.
